...
const QuestionBankUI = () => {
  ...
  const [showTmeWarning, setShowTmeWarning] = useState(false);
 ...
 const generateQuestions = async () => {
  ...
  if (currentStep === 'setup') {
    return (
        ...
        <h1 className="text-xl font-bold">AI Question Bank</h1>
        <button
  ...
  if (currentStep === 'quiz') {
    return (
      ...
      </div>  <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 p-4">
